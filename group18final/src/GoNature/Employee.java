...
/**
 * Employee represents an employee working within the system. Each employee has a unique ID and various details
 * such as first name, last name, worker ID, email, role, username, password, park ID, and authority level.
 *
