...
public class createOrderPageController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		waitlistB.setVisible(false);
		orderlistB.setVisible(false);
			...
			if (!Pattern.matches(regex, time)) {
				...
				if (ChatClient.saveData.equals("success")) {
					...
					if (ChatClient.saveData.equals("success")) {
						...
						primaryStage.show();
						popupCaller
								.showPopup("Your order has been regiestered!\nyou have been redirected to homescreen!");
						...
						waitlistB.setVisible(true);
						orderlistB.setVisible(true);
					}
